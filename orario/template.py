...
ISTRUZIONI = [
    ...
    "  NO o casella vuota = in due giorni con almeno un giorno in mezzo (lun/mer, mar/ven...), mai di fila, mai lo stesso giorno.",
    "  Se il docente non ha due giorni distanti il calcolo si ferma: o si scrive SI, o si apre un giorno al docente.",
    "  Unica eccezione: chi ha la musica da camera può fare tutto nel suo pomeriggio (un'ora prima, una dopo, mai attaccate).",

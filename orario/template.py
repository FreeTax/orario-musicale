...
ISTRUZIONI = [
    ...
    "  NO o casella vuota = MAI lo stesso giorno; in due giorni con almeno un giorno in mezzo (lun/mer, mar/ven...)",
    "  tutte le volte che il docente lo permette, altrimenti in due giorni di fila (segnalato negli avvisi).",
    "  Se il docente ha un giorno solo il calcolo si ferma: o si scrive SI, o si apre un giorno al docente.",
